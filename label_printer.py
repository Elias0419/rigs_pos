...
class LabelPrinter:
    ...
    def print_barcode_label(self, barcode_data, item_price, save_path):
        ...
        # Estimate text height as 1.2 times the font size
        ...
        barcode_img = barcode_img.resize((label_width - 2 * margin, barcode_height))
        label_image.paste(barcode_img, (margin, label_height // 4))
